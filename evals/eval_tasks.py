...
from evals.eval_hyperparameters import base_model, testset_name
...
def autograde_df(df_path, num_cpus=4):
    ...
    accuracy = len([grade for grade in final_grades if "A" in grade]) / len(final_grades)
    print("accuracy(should be around 0.75): ", accuracy)
